...
namespace LT.DigitalOffice.UserService.Data
{
    ...
    public class UserRepository : IUserRepository
    {
        ...
        public void AddCertificate(DbUserCertificate certificate)
        {
            if (certificate == null)
            {
        ...
        public DbUserCertificate GetCertificate(Guid certificateId)
        {
        ...
        public bool EditCertificate(DbUserCertificate certificate, JsonPatchDocument<DbUserCertificate> request)
        {
            if (certificate == null)
            {
                throw new ArgumentNullException(nameof(certificate));
        ...
        public bool RemoveCertificate(DbUserCertificate certificate)
        {
            if (certificate == null)
            {
                throw new ArgumentNullException(nameof(certificate));
